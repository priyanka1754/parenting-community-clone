...
@Component({
  ...
  template: `
    <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300 shadow-md z-50">
      <div class="flex justify-around items-center text-sm py-2">
        <a [routerLink]="['/home']" [ngClass]="isActive('/home') ? 'text-blue-600' : 'text-gray-600'" class="flex flex-col items-center hover:text-blue-600">
        ...
        <a [routerLink]="['/createPost']" [ngClass]="isActive('/createPost') ? 'text-blue-600' : 'text-gray-600'" class="flex flex-col items-center hover:text-blue-600">
